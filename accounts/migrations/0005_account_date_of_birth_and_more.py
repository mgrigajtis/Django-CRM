...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_modify_phone_req'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='account',
            name='date_of_birth',
            field=models.DateField(default=datetime.datetime(2024, 8, 14, 15, 30, 7, 439314, tzinfo=datetime.timezone.utc)),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='account',
            name='previous_billing_country',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Previous Address'),
        ),
        migrations.AddField(
            model_name='account',
            name='previous_residency_city',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Previous City'),
        ),
        migrations.AddField(
            model_name='account',
            name='previous_residency_postcode',
            field=models.CharField(blank=True, max_length=64, null=True, verbose_name='Previous Post/Zip-code'),
        ),
        migrations.AddField(
            model_name='account',
            name='previous_residency_state',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Previous State'),
        ),
        migrations.AddField(
            model_name='account',
            name='previous_residency_street',
            field=models.CharField(blank=True, max_length=55, null=True, verbose_name='Previous Street'),
        ),
    ]
